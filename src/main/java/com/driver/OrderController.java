...
public class OrderController {
    ...
    public ResponseEntity<String> addOrder(@RequestBody Order order){
        orderService.sendOrderToRepo(order);
        return new ResponseEntity<>("New order added successfully", HttpStatus.CREATED);
    }

    @PostMapping("/add-partner/{partnerId}")
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        orderService.sendPartnerToRepo(partnerId);
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam("orderId") String orderId, @RequestParam("partnerId") String partnerId){
        orderService.pairOrderAndPartner(orderId,partnerId);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        DeliveryPartner deliveryPartner = orderService.getPartnerFromRepo(partnerId);
